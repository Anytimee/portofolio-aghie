...
>
	...
	<div
		class="absolute inset-0 pointer-events-none bg-gradient-to-b from-transparent via-transparent to-background/50"
	></div>
	...
	>
		...
		<ChevronDown
			class="w-5 h-5 transition-transform duration-500 group-hover:translate-y-1"
		/>
	</button>
</section>
